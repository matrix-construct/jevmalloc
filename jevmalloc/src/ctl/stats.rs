...
//! only refreshed when the `jemalloc` "epoch" is advanced. See the
//! [`crate::ctl::epoch`] type for more information.
...
option! {
	...
	/// advanced. See the [`crate::ctl::epoch`] type for more information.
	///
